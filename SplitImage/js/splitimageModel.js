/**
 * @fileOverview This file provides the model layer of SplitImage
 * App. SplitImage App is a simple Privly application that supports
 * image encryption.
 *
 * For more details about the SplitIMage App, please visit Privly
 * website.
 *
 * Learn more about the MVC architecture of the Privly application:
 * https://priv.ly/pages/develop.html#MVCarchitecture
 * 
 * For this app, the controller layer for each view is:
 *   new:       SplitImage/js/new.js
 *   show:      SplitImage/js/show.js
 * 
 */
...
(function () {
  ...
  if (Privly.app.model.SplitImage !== undefined) {
    return;
  }

  /**
   * The Privly SplitImage Application
   */
  var SplitImageApp = function () {};

  /**
   * Generate a random key
   */
  SplitImageApp.prototype.generateRandomKey = function () {
   ...
   * @type {String}
   */
  SplitImageApp.prototype.name = 'SplitImage';
   ...
   *           {Boolean} isPublic
   */
  SplitImageApp.prototype.getRequestContent = function (raw) {
   ...
   */
  SplitImageApp.prototype.loadRawContent = function (url, json) {
   ...
   */
  SplitImageApp.prototype.postprocessLink = function (url) {
    // append random key
    if (url.indexOf("#") > 0) {
   ...
   */
  SplitImageApp.prototype.resolveKeyFromHistory = function (url) {
    var i;
    var urls = Privly.storage.get("SplitImage:URLs");
   ...
   * @param  {String} url
   */
  SplitImageApp.prototype.storeUrl = function (url) {
    ...
    urls.push(url);
    Privly.storage.set("SplitImage:URLs", urls);
  };
   ...
   * @param  {String} url
   */
  SplitImageApp.prototype.removeUrl = function (url) {
    if (privlyNetworkService.platformName() === 'HOSTED') {
      return;
    }
    var urls = Privly.storage.get("SplitImage:URLs");
   ...
   */
  SplitImageApp.prototype.getTTLOptions = function () {
    return Promise.resolve([
  ...
  Privly.app.model.SplitImage = SplitImageApp;
