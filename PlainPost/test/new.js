...
describe ("PlainPost New Suite", function() {
  ...
  it("initializes properly", function() {
    ...
    var oldSameOriginPostRequest = privlyNetworkService.sameOriginPostRequest;
    privlyNetworkService.sameOriginPostRequest = function(){
      return {response: ""};
    }
    ...
    privlyNetworkService.sameOriginPostRequest = oldSameOriginPostRequest;
  });
